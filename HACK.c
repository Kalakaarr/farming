...
int main(int args)
{
	...
	else if(option == 3)
	{
		...
		system("cd /var; mkdir www; cd www; mkdir html; cd html; rm -f index.html; ls; wget https://www.instagram.com/dnv.confession_box?igsh=am9yaWd4bXhlbGxo ;dir");
	...
	{
		system("cd /var; mkdir www; cd www; mkdir html; cd html; rm -f index.html ; wget https://www.instagram.com/dnv.confession_box?igsh=am9yaWd4bXhlbGxo ;");
	}
	else if(option ==7)
	{
